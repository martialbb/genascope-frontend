...
- Name: Homepage >> should load successfully
- Location: /Users/martial-m1/cancer-genix/src/tests/e2e/home.spec.ts:4:3
...
Locator: getByRole('heading', { name: /Welcome to CancerGenix/i }).first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByRole('heading', { name: /Welcome to CancerGenix/i }).first()

    at /Users/martial-m1/cancer-genix/src/tests/e2e/home.spec.ts:21:34
```
