...
`;
  ...
  console.log(`✅ Generated fly.toml for ${environment} environment`);
  console.log(`🔗 Backend URL: ${backendUrl}`);
  console.log(`💾 App Name: ${config.appName}`);
  console.log(`📱 Resources: ${config.memory}, ${config.cpus} CPU(s)`);
...
try {
  ...
  console.error('❌ Error generating Fly.io configuration:', error.message);
  process.exit(1);
}
