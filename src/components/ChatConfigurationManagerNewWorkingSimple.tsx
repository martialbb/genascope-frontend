...
const ChatConfigurationManagerNewWorkingSimple: React.FC = () => {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• Age greater than 40 (for screening eligibility)</li>
              <li>• Family history contains "breast cancer" (for high-risk patients)</li>
              <li>• Previous screening equals "overdue" (for follow-up reminders)</li>
              <li>• Risk factors in list ["BRCA1", "BRCA2"] (for genetic counseling)</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  const renderOutcomesStep = () => {
    const actionTypes = [
      ...
      { value: 'flag_chart', label: 'Flag Chart', icon: '🚩' },
      { value: 'send_message', label: 'Send Message', icon: '�' },
      { value: 'schedule_followup', label: 'Schedule Follow-up', icon: '📅' }
    ];
      ...
      <div className="space-y-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• High Risk Identified → Schedule genetic counseling appointment</li>
              <li>• Screening Recommended → Send appointment booking notification</li>
              <li>• Patient Declined → Log interaction and set follow-up reminder</li>
              <li>• Conversation Complete → Generate patient summary report</li>
            </ul>
          </div>
        </div>
      </div>
                      ...
                      {strategies.map((strategy, index) => (
                        <tr key={strategy.id} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4 text-gray-500">
                            {strategy.updated_at ? new Date(strategy.updated_at).toLocaleDateString() : '—'}
                          </td>
                          <td className="py-3 px-4">
