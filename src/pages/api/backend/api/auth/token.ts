/**
 * Server-side API endpoint for authentication token
 * This matches the expected path: /api/backend/api/auth/token
...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    console.error('Server API Error - POST /api/backend/api/auth/token:', error);
